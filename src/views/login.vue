    ...
    <transition name="fade" leave-active-class="animated bounceOutRight">
      <div class="login-container" v-if="changeBtn">
        <div class="login-face">
          ...
          <div class="forget-pwd" @click="$toast('忘记密码？')">忘记密码？</div>
        </div>
        <div class="login-submit">
          <van-checkbox v-model="checked" icon-size="15px" @click="forgetUname"
            >记住账号</van-checkbox
          >
        ...
        <div class="otherLogin">
          <img
            ...
            @click="$toast('微信登录')"
          />
          <img src="../assets/images/qq.png" alt="" @click="$toast('QQ登录')" />
          <img
